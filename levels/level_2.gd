...
func init(_nb_players: int) -> void:
	...
	var mission3: Mission = Mission.new(TypeMission.BOMB, 0, 1, false, "Defuse bomb 0")
	var mission4: Mission = Mission.new(TypeMission.SHRINECHANCE, 0, 0, false, "Succeed at the luck chance")
